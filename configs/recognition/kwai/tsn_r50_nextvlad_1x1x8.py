...
optimizer = dict(
    type='AdamW',
    lr=0.0005, # 0.01 is used for 8 gpus 32 videos/gpu
    weight_decay=0.0001)
...
resume_from = './work_dirs/tsn_r50_nextvlad_1x1x8_50e_k400/best_mmit_mean_average_precision_epoch1_iter_7500.pth'
