...
# optimizer
optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001)  # 0.01 lr is used for 8 gpus, fine tune / 2
...
# runtime settings
work_dir = './work_dirs/tsn_r50_video_w256_1x1x8_kinetics400_ft50e_hetu36_rgb/'