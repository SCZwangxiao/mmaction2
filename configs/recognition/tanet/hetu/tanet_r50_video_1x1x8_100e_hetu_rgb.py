...
data_root = '/home/wangxiao13/annotation/data/hetu/videos'
data_root_val = '/home/wangxiao13/annotation/data/hetu/videos'
ann_file_train = '/home/wangxiao13/annotation/data/hetu/hetu_video_train_list.txt'
ann_file_val = '/home/wangxiao13/annotation/data/hetu/hetu_video_val_list.txt'
ann_file_test = '/home/wangxiao13/annotation/data/hetu/hetu_video_test_list.txt'
...
evaluation = dict(
    ...
    metric_options=dict(top_k_precision=dict(topk=(1, 3)), top_k_recall=dict(topk=(3, 5))),
...
optimizer = dict(
    ...
    lr=0.04,  # 0.01 lr is used for 8 gpus, 8 video per gpu
    momentum=0.9,
    weight_decay=0.0001)
...
# runtime settings
work_dir = './work_dirs/tanet_r50_video_1x1x8_100e_hetu_rgb/'
