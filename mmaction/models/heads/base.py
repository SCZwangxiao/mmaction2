...
class NeXtVLAD(nn.Module):
    """
        This is a PyTorch implementation of the NeXtVLAD + Context Gating model. For more
    ...
    def forward(self, input):
        ...
        #[B*num_segs, expansion*feature_size]
        activation = self.activation_bn(input @ self.cluster_weights)
        #[B*num_segs, groups*cluster_size]
        activation = activation.reshape(-1,
                                        num_segs*self.groups, self.cluster_size)
        #[B, num_segs*groups, cluster_size]
